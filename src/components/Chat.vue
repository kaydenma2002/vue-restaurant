<template>
    <div class="w-96  border rounded chat-box overflow-auto flex flex-col chat-popup z-10    bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 "
        v-if="isOpen">
        <div class="w-full ">
            ...
            <div class=" w-full h-106 p-6 overflow-y-auto " ref="chatContainer">
            ...
            <div class="">
                ...
                <div class="flex justify-between">
                    ...
                    <button type="button" @click="submitbyChoices('contact')" class="
                                                                                                                    bg-indigo-600
                                                                                                                    px-2
                                                                                                                    py-2
                                                                                                                    rounded-lg
                    ...
                    if(!this.v$.$error) {
                        HTTPS.post('/submit-reservation', {
                            ...
                            if(res.data.success != false) {
                                this.verifyPhone = true
                                Swal.fire('Your reservation has been confirmed', '', 'success')
                            } else {
                                console.log(res)
                            }
                        }).catch((error) => {
