                ...
                <div class="w-full md:w-1/2">
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" v-model="searchTerm" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                        </div>
                    </form>
                </div>
    ...
    filteredData() {
      return this.restaurant.filter(item => {
        return item.name.toLowerCase().includes(this.searchTerm.toLowerCase()) ||
               item.occupation.toLowerCase().includes(this.searchTerm.toLowerCase());
      });
    }
  },
};
